 ...
 * aquellos pedidos que se realizen dentro de la península ibérica.
 * 
 * @author NTT Data - Carlos González Ruiz
 */
@Service("Spain")
public class OrderServiceSpainImpl implements OrderServiceI {
	...
	public String toString() {
		return "[Servicio de pedido dentro de la península]";
	}
